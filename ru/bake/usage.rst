...
.. meta::
    ...
    :keywords lang=ru: интерфейс командной строки, функциональное приложение, база данных, конфигурация базы данных, сценарий bash, базовые компоненты, проект, модель, путь пути, генерация кода, строительные леса, пользователи Windows, файл конфигурации, несколько минут, конфигурация, iew, оболочка, модели, запуск, mysql
